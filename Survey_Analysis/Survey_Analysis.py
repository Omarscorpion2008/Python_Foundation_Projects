class Survey_Analyser:
    ...
    def output(self):
        ...
        print('-' * 30)
        print(f"\nAverage Satisfaction : {self.average_satisfaction:.2f}")
        print(f"Average Usability Score : {self.average_usability_score:.2f}")
        print(f"Average Recommendation Score : {self.average_recommendation_score:.2f}")
        print("\nHow did the user hear about the program ?")
        print(f"Social Media : {self.socialmedia_percentage:.2f}%")
        print(f"Friends : {self.friend_percentage:.2f}%")
        print(f"Advertisement : {self.advertisement_percentage:.2f}%")
        print(f"other : {self.other_percentage:.2f}%")
        print("\nWould the user use the program again ?")
        print(f"Yes : {self.reusage_yes_percentage:.2f}% | No : {self.reusage_no_percentage:.2f}%")
        print("\nDid the program meet the user's expectations ?")
        print(f"Yes : {self.expectations_yes_percentage:.2f}% | No : {self.expectations_no_percentage:.2f}%")
        print("\nHow often does the user use the program ?")
        print(f"Daily : {self.daily_percentage:.2f}%")
        print(f"Weekly : {self.weekly_percentage:.2f}%")
        print(f"Monthly : {self.monthly_percentage:.2f}%")
        print(f"Rarely : {self.rarely_percentage:.2f}%")
